...
# 0.50 gives better sensitivity than 0.65
# without making the detector extremely aggressive.
...
# Number of frames to inspect for GIFs/videos.
#
# More frames = better detection,
# but also more CPU usage and longer scanning time.
MAX_MEDIA_FRAMES = 40

# Minimum number of frames to inspect even for very short media.
MIN_MEDIA_FRAMES = 12

# Maximum frame sampling rate.
MAX_FPS = 5

# JPEG quality used by FFmpeg.
FRAME_QUALITY = "3"
...
async def extract_and_scan_media(
    ...
    try:
        ...
        logger.info(
            "Scanning approximately %d frames.",
            frame_count
        )
        ...
        # IMPORTANT:
        #
        # We use fps based on the duration and frame count,
        # then limit the total number of extracted frames.
        #
        # This prevents only scanning the beginning.
        #
...
async def help_command(
    ...
    help_text = (
        ...
        "• Sexual/NSFW words\n"
        "• NSFW photos\n"
        "• Multi-frame GIF scanning\n"
        "• GIF document scanning\n"
        "• Multi-frame video scanning\n"
        "• Human verification"
    )
...
async def status_command(
    ...
    status_text = (
        ...
        "• Whole-Media GIF Scanning: Active\n"
        "• GIF Document Scanning: Active\n"
        "• Whole-Media Video Scanning: Active\n"
        "• Verification: Active"
    )
...
async def features_command(
    ...
    features_text = (
        ...
        "🎞️ Whole-Media GIF Detection\n"
        "📁 GIF Document Detection\n"
        "🎥 Whole-Media Video Detection\n"
